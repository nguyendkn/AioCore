...
public static class NotionExtensions
{
    ...
    private static bool Transform(Block block, StringBuilder sb)
    {
    ...
    private static StringBuilder Append(IReadOnlyCollection<RichText> data, StringBuilder sb)
    {
        if (data == null)
            return sb;
    ...
    private static StringBuilder Append(RichText line, StringBuilder sb)
    {
        if (line == null)
            return sb;
    ...
    private static StringBuilder Append(Text text, StringBuilder sb)
    {
        if (text == null)
            return sb;
